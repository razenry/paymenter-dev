...
namespace Paymenter\Extensions\Gateways\Xendit_Permata;
...
class Xendit_Permata extends Gateway
{
    ...
    public function pay(Invoice $invoice, $total)
    {
        ...
        return $lib->pay(['PERMATA'], $fixedFee, $percentageFee, $invoiceDuration, $invoice, $total);
    }
