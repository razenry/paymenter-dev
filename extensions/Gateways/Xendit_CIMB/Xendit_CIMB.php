...
namespace Paymenter\Extensions\Gateways\Xendit_CIMB;
...
class Xendit_CIMB extends Gateway
{
    ...
    public function pay(Invoice $invoice, $total)
    {
        ...
        return $lib->pay(['CIMB'], $fixedFee, $percentageFee, $invoiceDuration, $invoice, $total);
    }
