...
namespace Paymenter\Extensions\Gateways\Xendit_BSI;
...
class Xendit_BSI extends Gateway
{
    ...
    public function pay(Invoice $invoice, $total)
    {
        ...
        return $lib->pay(['BSI'], $fixedFee, $percentageFee, $invoiceDuration, $invoice, $total);
    }
