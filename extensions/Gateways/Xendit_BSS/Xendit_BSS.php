...
namespace Paymenter\Extensions\Gateways\Xendit_BSS;
...
class Xendit_BSS extends Gateway
{
    ...
    public function pay(Invoice $invoice, $total)
    {
        ...
        return $lib->pay(['BSS'], $fixedFee, $percentageFee, $invoiceDuration, $invoice, $total);
    }
