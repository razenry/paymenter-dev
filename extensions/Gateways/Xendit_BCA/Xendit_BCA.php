...
namespace Paymenter\Extensions\Gateways\Xendit_BCA;
...
class Xendit_BCA extends Gateway
{
    ...
    public function pay(Invoice $invoice, $total)
    {
        ...
        return $lib->pay(['BCA'], $fixedFee, $percentageFee, $invoiceDuration, $invoice, $total);
    }
