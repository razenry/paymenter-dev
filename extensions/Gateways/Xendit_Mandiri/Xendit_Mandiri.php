...
namespace Paymenter\Extensions\Gateways\Xendit_Mandiri;
...
class Xendit_Mandiri extends Gateway
{
    ...
    public function pay(Invoice $invoice, $total)
    {
        ...
        return $lib->pay(['MANDIRI'], $fixedFee, $percentageFee, $invoiceDuration, $invoice, $total);
    }
