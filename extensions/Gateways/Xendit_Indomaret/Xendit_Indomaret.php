...
namespace Paymenter\Extensions\Gateways\Xendit_Indomaret;
...
class Xendit_Indomaret extends Gateway
{
    ...
    public function pay(Invoice $invoice, $total)
    {
        ...
        return $lib->pay(['INDOMARET'], $fixedFee, $percentageFee, $invoiceDuration, $invoice, $total);
    }
