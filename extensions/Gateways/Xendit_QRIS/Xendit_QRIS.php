...
namespace Paymenter\Extensions\Gateways\Xendit_QRIS;
...
class Xendit_QRIS extends Gateway
{
    ...
    public function pay(Invoice $invoice, $total)
    {
        ...
        return $lib->pay(['QRIS'], $fixedFee, $percentageFee, $invoiceDuration, $invoice, $total);
    }
