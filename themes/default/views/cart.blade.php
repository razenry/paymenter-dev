    ...
    <div class="flex flex-col md:grid md:grid-cols-4 gap-8">
        <div class="flex flex-col col-span-3 gap-4">
            ...
            @foreach (Cart::items() as $item)
                <div
                    class="flex flex-row justify-between w-full bg-background-secondary p-3 rounded-md border border-neutral">
                        ...
                        <p class="text-sm">
                            @foreach ($item->config_options as $option)
                                <span class="flex flex-row items-center">
                                    <x-ri-settings-3-fill class="size-3 mr-2 mt-1.5" />
        ...
        <div class="flex flex-col gap-4">
            @if (Cart::items()->count() > 0)
                <div
                    class="flex flex-col gap-2 w-full col-span-1 bg-background-secondary p-3 rounded-md border border-neutral">
