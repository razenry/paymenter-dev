         ...
         <div class="flex flex-col sm:flex-row justify-between items-center gap-4">
             <h1 class="text-2xl font-bold">Invoice #{{ $invoice->number }}</h1>
              ...
              <div class="flex items-center gap-4">
                  ...
                  <x-button.danger wire:click="$set('showCancelModal', true)" class="text-sm">
                      Cancel Invoice
                  </x-button.danger>
                  @endif
...
@if($showCancelModal)
    <x-modal open="true" title="Cancel Invoice" width="max-w-md">
        <div class="p-6">
            <div class="flex items-start mb-4">
                <div class="flex-shrink-0">
                    <x-ri-error-warning-fill class="size-6 text-error" />
                </div>
                <div class="ml-3">
            ...
            <div class="flex gap-3">
                <x-button.danger wire:click="cancelInvoice" wire:loading.attr="disabled" class="flex-1">
        ...
        <x-slot name="closeTrigger">
            <button wire:click="$set('showCancelModal', false)" @click="open = false" class="text-base/70 hover:text-base transition-colors duration-200">
