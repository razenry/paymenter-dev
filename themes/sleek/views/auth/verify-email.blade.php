<div
    ...
    <div class="flex flex-col items-center mb-4">
        ...
        <h1 class="text-xl font-bold text-center text-base">
            {{ __('auth.verification.notice') }}
        </h1>
        <p class="text-xs text-base/60 mt-1 text-center">
            {{ __('auth.verification.check_your_email') }}
        </p>
    </div>

    @if (session()->has('email_verification_sent'))
        <div class="rounded-lg border  bg-green-500/10 px-4 py-3 text-sm  text-center">
