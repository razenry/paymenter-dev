...
Schedule::command(ProvisionPendingServices::class)->description('Provision services that are pending, fully paid, and have no unpaid invoices left.')->everyFiveMinutes()->withoutOverlapping()->onOneServer();
