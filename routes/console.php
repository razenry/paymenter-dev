...
use App\Console\Commands\ProvisionPendingServices;
...
Schedule::command(ProvisionPendingServices::class)->description('Provision services that are pending, fully paid, and have no unpaid invoices left.')->everyThirtyMinutes()->withoutOverlapping()->onOneServer();
